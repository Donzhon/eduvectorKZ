...
const SITE_I18N = {
  eng: {
    ...
    "about.hero.lead":
      "EduVector Distribution brings modern educational technology to schools, kindergartens, and STEM classrooms across the region.",
    ...
    "about.do.1.text": "We supply trusted EdTech product lines to institutions across Kazakhstan and beyond.",
    ...
    "about.contact.lead":
      "Kazakhstan, Astana, Rakhymzhan Koshkarbayev Ave. 1/4, 3rd floor.",
  ...
  kaz: {
    ...
    "about.hero.lead":
      "EduVector Distribution өңірдегі мектептерге, балабақшаларға және STEM сыныптарына заманауи білім беру технологияларын жеткізеді.",
    ...
    "about.do.1.text": "Қазақстан мен одан тыс жердегі мекемелерге сенімді EdTech өнім желілерін жеткіземіз.",
    ...
    "about.contact.lead":
      "Қазақстан, Астана қ., Рахымжан Қошқарбаев даңғылы 1/4, 3-ші қабат.",
